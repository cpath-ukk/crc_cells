...
input_WSI_folder = '/media/vmitchell/ssd8tb/04_CoCa_PRIM_ome_tiff/'
input_mask_folder = '/media/vmitchell/ssd8tb/04_CoCa_PRIM_ome_tiff_MAPS/mask_filter/'
input_geojson_folder = '/media/vmitchell/ssd8tb/04_CoCa_PRIM_ome_tiff_NUCLEI/'
input_qc_folder = '/media/vmitchell/ssd8tb/04_CoCa_PRIM_ome_tiff_QC/tis_det_mask/'
input_thumbnail_folder = '/media/vmitchell/ssd8tb/04_CoCa_PRIM_ome_tiff_MAPS/tis_det_thumbnail/'
include_image_folder = ''

output_path = '/media/vmitchell/ssd8tb/04_CoCa_PRIM_ome_tiff_CSV/'
